...
const AmericanBusinessAccess = () => {
  ...
  const steps = [
    {
      ...
      description: "دسترسی به پشتیبانی اختصاصی و راهنمایی مستقیم",
      icon: <MessageCircle size={32} className="text-emerald-600" />,
      bgColor: "bg-emerald-50 dark:bg-emerald-950/30",
      borderColor: "border-emerald-200 dark:border-emerald-800",
      buttons: [
        { label: "💬 فعال‌سازی پشتیبانی", url: "https://t.me/americanbusiness_support" }
      ],
      activation: true
    },
    {
      ...
      description: "عضویت در کانال برای دریافت فایل‌ها و اطلاعیه‌ها",
    ...
    },
    {
      id: "videos",
      title: "🎥 جلسات دوره",
      description: "مشاهده تمام جلسات آموزشی بیزینس آمریکایی",
      icon: <Play size={32} className="text-red-600" />,
    ...
    },
    {
      ...
      description: "فعال‌سازی دستیار اختصاصی رفیعی برای پاسخ به سوالات",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-950">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-red-600 py-16">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              🇺🇸 دوره بیزینس آمریکایی
            </h1>
            <p className="text-lg md:text-xl text-blue-100 mb-6">
              راهنمای جامع ورود به بازار آمریکا
            </p>
      ...
      {/* Footer Message */}
      <div className="py-8 bg-gradient-to-r from-blue-600 to-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-xl font-bold mb-2">🚀 آماده برای شروع کسب‌وکار در آمریکا؟</h3>

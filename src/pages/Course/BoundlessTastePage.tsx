      ...
      <div className="container py-16">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Course Info */}
            <div>
              <h1 className="text-4xl font-bold mb-4">مزه بدون مرز</h1>
              <p className="text-xl text-gray-600 mb-6">
                Boundless Taste - تجربه کسب و کار بین‌المللی
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <p>آشنایی با اصول کسب و کار بین‌المللی</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p>یادگیری تکنیک‌های توسعه کسب و کار</p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p>شناخت بازارهای جهانی و فرصت‌های سرمایه‌گذاری</p>
                </div>
              </div>

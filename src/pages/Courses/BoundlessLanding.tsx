  ...
  const weeklyGifts = [
    {
      ...
      desc: "سیستم چندزبانه ساخت فروشگاه با هوش مصنوعی برای محصولات برنده (فارسی و انگلیسی) با پشتیبانی Stripe و زرین‌پال، محصولات فیزیکی و دیجیتال — ارزش ۵ دلار",
      icon: Globe,
    },
    {
      title: "دوره «شروع ایران» (۲۰۰ دقیقه)",
      desc: "آموزش راه‌اندازی کسب‌وکار آنلاین در ایران با پلتفرم‌های بومی (باله، ترب، لندین و…)؛ کمپین فروش، تبلیغات، بازاریابی پیامکی، ساخت فروشگاه و فروش خدمات",
      icon: GraduationCap,
    },
    {
      title: "اشتراک یک‌ماهه ۱ گیگابایت Boundless Network",

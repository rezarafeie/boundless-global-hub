...
export const fa = {
  ...
  boundlessLandingWhatLearn: "آنچه به آن تسلط خواهید یافت",
  boundlessLandingSkill1: "تفکر جهانی",
  ...
  boundlessLandingBonusesTitle: "بونوس‌های ویژه",
  boundlessLandingBonus1: "دوره درآمد غیرفعال با هوش مصنوعی",
  boundlessLandingBonus2: "ارزیابی حرفه‌ای",
  boundlessLandingBonus3: "راهنمای درآمد دلاری",
  boundlessLandingTestimonialsTitle: "داستان‌های موفقیت",
  boundlessLandingFAQTitle: "سوالات متداول",
  boundlessLandingFitTitle: "آیا این برنامه مناسب شماست؟",
  ...
  boundlessLandingFitMigrate: "آماده مهاجرت",
  boundlessLandingStickyOffer: "پیشنهاد محدود: ۸۶ درصد تخفیف",

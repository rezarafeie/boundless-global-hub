...
export const JSON_TEMPLATE = {
  ...
  challenge: {
    ...
    gamification_enabled: true, streak_enabled: true, notifications_enabled: true, leaderboard_enabled: true, unlock_next_on_complete: false, allow_late_submission: false, allow_join_after_start: false, require_messenger_activation: true, require_coach_approval: true, coach_email: 'rezarafeie13@gmail.com', hide_leaderboard: false, hide_daily_checkin: false, hide_rewards: false,

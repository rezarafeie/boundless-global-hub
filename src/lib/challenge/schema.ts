...
export const JSON_TEMPLATE = {
  ...
  challenge: {
    ...
    gamification_enabled: true, streak_enabled: true, notifications_enabled: true, leaderboard_enabled: true,
...
export async function importChallengeJson(j: any, mode: 'create' | 'update', onLog?: (m: string) => void): Promise<string> {
  ...
  try {
    ...
    const row: any = {
      ...
      notifications_enabled: c.notifications_enabled ?? true, leaderboard_enabled: c.leaderboard_enabled ?? true,
...
export async function exportChallengeJson(id: string, opts: { includeAssignments?: boolean } = { includeAssignments: true }) {
  ...
  return {
    ...
    challenge: {
      ...
      leaderboard_enabled: c.leaderboard_enabled, ai_review_default: c.ai_review_default, coach_review_default: c.coach_review_default,
    },

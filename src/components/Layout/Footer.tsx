        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              پلتفرم آموزش آنلاین برای توسعه مهارت‌ها و کسب‌وکار
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-300 hover:text-white transition-colors text-sm flex items-center">
                  صفحه اصلی
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/assessment-center" className="text-gray-300 hover:text-white transition-colors text-sm flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center text-sm">
                ...
                <a href="mailto:info@rafiei.co" className="text-gray-300 hover:text-white transition-colors">
                  info@rafiei.co
                </a>
              </li>
              <li className="flex items-center text-sm">
                <Phone className="mr-2 h-4 w-4 text-gray-400" />
                <a href="tel:+989123456789" className="text-gray-300 hover:text-white transition-colors">
                  +98 912 345 6789
                </a>
              </li>
              <li className="flex items-center text-sm">
                <MessageCircle className="mr-2 h-4 w-4 text-gray-400" />
                <a href="https://t.me/rafieiacademy" className="text-gray-300 hover:text-white transition-colors">
                  @rafieiacademy
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-3 rtl:space-x-reverse mb-6">
              <a href="https://instagram.com" className="bg-gray-700 hover:bg-gray-600 p-2 rounded-lg transition-colors">
              ...
              <a href="https://t.me/" className="bg-gray-700 hover:bg-gray-600 p-2 rounded-lg transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://wa.me/" className="bg-gray-700 hover:bg-gray-600 p-2 rounded-lg transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Dark Mode Toggle */}
            <div>
              <h5 className="text-sm font-medium mb-2">تم صفحه</h5>
              <Button
                variant="outline"
                size="sm"

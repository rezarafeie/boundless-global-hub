      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-gray-200 transition-colors text-sm flex items-center hover:translate-x-1 duration-200">
                  {translations.home}
                </Link>
              </li>
              <li>
                <Link to="/courses" className="text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-gray-200 transition-colors text-sm flex items-center hover:translate-x-1 duration-200">
                  <BookOpen className="mr-2 h-3 w-3" />
                  {translations.trainingCenter}
                </Link>
              </li>
              <li>
                <Link to="/assessment-center" className="text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-gray-200 transition-colors text-sm flex items-center hover:translate-x-1 duration-200">
                  <User className="mr-2 h-3 w-3" />
                  {translations.assessmentCenter}
                </Link>
              </li>
              <li>
                <Link to="/mag" className="text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-gray-200 transition-colors text-sm flex items-center hover:translate-x-1 duration-200">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/support" className="text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-gray-200 transition-colors text-sm flex items-center hover:translate-x-1 duration-200">
              ...
              <li className="flex items-center text-sm">
                ...
                <a href="mailto:hi@rafeie.com" className="text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-gray-200 transition-colors">
                  hi@rafeie.com
                </a>
              </li>
              <li className="flex items-center text-sm">
                <Phone className="mr-2 h-4 w-4 text-gray-400 dark:text-gray-500" />
                <a href="tel:02128427131" className="text-gray-300 dark:text-gray-400 hover:text-white dark:hover:text-gray-200 transition-colors">
                  021-28427131
                </a>
              </li>
              <li className="flex items-center text-sm">
          ...
          <div>
            ...
            <div className="flex items-center space-x-3 rtl:space-x-reverse mb-6">
              <a href="https://instagram.com/rafieiacademy" className="bg-gray-700 dark:bg-gray-800 hover:bg-gray-600 dark:hover:bg-gray-700 p-2 rounded-lg transition-all duration-200 hover:scale-110">
              ...
              <a href="https://t.me/rafieiacademy" className="bg-gray-700 dark:bg-gray-800 hover:bg-gray-600 dark:hover:bg-gray-700 p-2 rounded-lg transition-all duration-200 hover:scale-110">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://wa.me/989123456789" className="bg-gray-700 dark:bg-gray-800 hover:bg-gray-600 dark:hover:bg-gray-700 p-2 rounded-lg transition-all duration-200 hover:scale-110">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Button
                ...
                className="bg-gray-700 dark:bg-gray-800 hover:bg-gray-600 dark:hover:bg-gray-700 p-2 rounded-lg transition-all duration-200 text-white hover:scale-110"
        ...
        <div className="pt-8 border-t border-gray-700 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 rtl:space-x-reverse">
            <Link to="/about" className="text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-300 text-sm transition-colors hover:translate-y-[-1px] duration-200">
              {translations.aboutUs}
            </Link>
            <Link to="/terms" className="text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-300 text-sm transition-colors hover:translate-y-[-1px] duration-200">
              {translations.termsOfService}
            </Link>
            <Link to="/privacy" className="text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-300 text-sm transition-colors hover:translate-y-[-1px] duration-200">

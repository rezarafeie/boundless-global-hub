...
const PendingApprovalPayments: React.FC<PendingApprovalPaymentsProps> = ({ onRefresh }) => {
  ...
  const confirmReject = async () => {
    ...
    try {
      setRejecting(true);
      console.log('Rejecting enrollment:', selectedEnrollment, 'Reason:', rejectionReason);
      ...
      <Dialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              لطفاً دلیل رد این درخواست پرداخت را وارد کنید. این پیام برای کاربر نمایش داده خواهد شد.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
            <Textarea
              placeholder="دلیل رد درخواست را اینجا وارد کنید..."
          ...
          <DialogFooter>
            ...
            >
              {rejecting ? 'در حال پردازش...' : 'رد درخواست'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>

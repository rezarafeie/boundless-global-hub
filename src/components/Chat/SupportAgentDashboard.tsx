...
import { Send, MessageCircle, Users, User, HeadphonesIcon } from 'lucide-react';
...
const SupportAgentDashboard: React.FC<SupportAgentDashboardProps> = ({ currentUserId, userName }) => {

...
BEGIN
  ...
  IF (NEW.payment_status IN ('completed', 'success') AND 
    ...
    PERFORM net.http_post(
      ...
      body := json_build_object('enrollmentId', NEW.id)::text
    );
...
-- Test by calling the function directly for the existing enrollment
SELECT net.http_post(
  'https://ihhetvwuhqohbfgkqoxw.supabase.co/functions/v1/send-enrollment-email',
  '{"enrollmentId": "abab63bf-b391-4a59-a7b6-15f721db3914"}',
  'application/json'
);